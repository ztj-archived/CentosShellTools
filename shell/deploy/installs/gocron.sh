...
Url="https://github.com/ouqiang/gocron/releases/download/v${Version}/gocron-v${Version}-linux-amd64.tar.gz"
PackagePath="/data/backups/softwares/gocron-v${Version}-linux-amd64.tar.gz"
InstallPath="/data/bin/gocron"

### 判断软件是否已经安装
File="/data/bin/gocron/gocron"
...
chmod 755 /data/bin/gocron/gocron

### 验证软件安装
/data/bin/gocron/gocron -v > /dev/null 2>&1
