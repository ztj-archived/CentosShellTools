...
Command="${1}"
ServiceConfig="${2}"
ServiceBin="/data/bin/frp/frpc"
ServiceDefaultConfig="/data/configs/frp/frpc.ini"
ServiceLog="/data/logs/service/${ShellName}.`date +%Y-%m-%d-%H-%M-%S`.log"

[ "${ServiceConfig}" == "" ] && ServiceConfig="${ServiceDefaultConfig}"
