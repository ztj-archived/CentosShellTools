...
[ -f "${SoftwareInstallPath}" ] && echo ">>>>> Error: The software has been installed" && exit 1

[ -d "${SoftwareInstallPath}" ] && echo ">>>>> Error: The software has been installed" && exit 1
...
[ $? -ne 0 ] && echo ">>>>> Error: Software download error" && exit 1
...
[ $? -ne 0 ] && echo ">>>>> Error: Software unzip|untar error" && exit 1
